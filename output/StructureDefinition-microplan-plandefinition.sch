...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition/f:action">
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/microplan/StructureDefinition/TargetLocationType']) &gt;= 1">extension with URL = 'http://smart.who.int/microplan/StructureDefinition/TargetLocationType': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/microplan/StructureDefinition/TargetLocationType']) &lt;= 1">extension with URL = 'http://smart.who.int/microplan/StructureDefinition/TargetLocationType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:title) &gt;= 1">title: minimum cardinality of 'title' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
